...
path_base_json = r'xxx/xxx//bird_fsod/annotations/base_train.json'
path_novel_json = r'xxx/xxx//bird_fsod/annotations/novel.json'
...
def combine_multi_layer(ckpt1, ckpt2):
    root_param_names = ['roi_heads.box_predictor_dict.root.cls_score',
                        'roi_heads.box_predictor.cls_score', 'roi_heads.box_predictor.bbox_pred']
