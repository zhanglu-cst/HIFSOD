...
_C.MODEL.ROI_BOX_HEAD.CONTRASTIVE_BRANCH = CN(
        {'ENABLED': False})  # to be used to enable contrastive loss for double head
...
# -----------------
_C.MODEL.PROB_LOSS = CN()
_C.MODEL.PROB_LOSS.ENABLE = False
_C.MODEL.PROB_LOSS.BETA = 0.5
_C.MODEL.PROB_LOSS.TOPK_PROPOSAL = 50

_C.MODEL.ROOT_WEIGHT = 1.0
_C.MODEL.INNER_WEIGHT = 1.0

_C.CATS_UES_JSON = ''

_C.BALANCE_TRAIN_TREE = CN()
_C.BALANCE_TRAIN_TREE.ENABLE = True
_C.BALANCE_TRAIN_TREE.MAX_SAMPLE_RATE = 5

_C.TEST.ADD_FLAT_SCORE = True
