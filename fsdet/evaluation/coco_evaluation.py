...
class COCOEvaluator(DatasetEvaluator):
    ...
    def __init__(self, dataset_name, cfg, distributed, output_dir = None):
        ...
        self._base_classes = list(self._metadata.base_dataset_id_to_contiguous_id.keys())

        self._novel_classes = list(self._metadata.novel_dataset_id_to_contiguous_id.keys())
