...
from fsdet.data.tree_aug import resample_train_dataset_dict_to_balance_tree
...
def build_detection_train_loader(cfg, mapper=None):
    ...
    dataset_dicts = resample_train_dataset_dict_to_balance_tree(cfg,dataset_dicts)
